...
好的，这是一个 Markdown 表格形式的总结，方便你记录和对比。

### Cursor 三种核心模式对比 (Chat, Plan, Agent)

| 特性 | Chat (聊天模式) | Plan (计划模式) | Agent (代理模式) |
| :--- | :--- | :--- | :--- |
| **核心思想** | **即时问答** <br> 快速响应你的具体指令 | **谋定而后动** <br> 在执行前先生成一份详细的行动计划 | **自主完成任务** <br> 像一个初级开发者一样，独立思考并完成整个任务 |
| **自主性** | **低** <br> 完全听从你的指令，不做额外操作 | **中** <br> 自主规划步骤，但需要你批准后才执行 | **高** <br> 自主分析、编码、调试，直到达成目标 |
| **交互流程** | 1. 你提问或给出指令 <br> 2. AI 提供回答或代码 <br> 3. 你决定是否采纳 | 1. 你提出一个较复杂的任务 <br> 2. AI 生成一份详细的修改计划 <br> 3. 你审查并批准计划 <br> 4. AI 按计划执行 | 1. 你给出一个高阶目标 <br> 2. AI 自主分析、规划、修改代码、甚至 Debug <br> 3. 你在旁边观察过程，并可在必要时干预 |
| **适用场景** | • 快速生成/修改小段代码 <br> • 解释/理解代码 <br> • 简单 Debug <br> • 学习语法或新概念 | • 开发新功能（涉及多文件） <br> • 较复杂的代码重构 <br> • 希望在 AI 大规模修改前审查其思路 | • 端到端的功能开发 <br> • 修复复杂的 Bug 或 CI/CD 错误 <br> • 大型项目迁移或依赖升级 <br> • 让 AI 探索性地完成任务 |
| **控制力** | **高** <br> 你拥有每一步的绝对控制权 | **中** <br> 你负责审批计划，控制整体方向 | **低** <br> 你设定最终目标，但执行过程由 AI 主导 |
| **比喻** | **代码助手** (Pair Programmer) | **项目规划师** (Tech Lead) | **初级开发工程师** (Junior Developer) |
...
* 发展与融资（文中原文）：
  ...
  * 2023 年（文中）：Cursor 获得 800 万美元融资

  * 2024 年（文中）：Cursor 完成 6000 万美元 A 轮融资，公司估值超过 4 亿美元

* Cursor 为专业版软件，标准报价示例：每月 20 美金（深度使用者建议付费）。
...
* 作者推荐（基于个人体验）：
  ...
  * `gpt 4o`：适合综合域问答、需求分析（用在 Chat/分析场景）。
  * `cloud3.5`：更擅长代码生成（在 Composer 中使用）。
* 模型均有使用配额（超配额需换账号或改模型）；无限量的模型有但能力往往较弱。

### 4) 选区唤起与快捷使用

* 可选中代码块后用快捷键唤起 Chat/Composer，或在侧边栏打开上下文聊天（侧边栏有历史记录，推荐使用）。
* 常用快捷键示例：`Command + .`切换模式，`Command + I`打开 AI 面板
